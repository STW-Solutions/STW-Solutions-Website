            ...
            <div className="container-fluid">
                <div className="row mx-md-5 px-md-5">
                    <div className="col-md-6">
                        <h1 className="fw-bolder py-5 text-md-start text-center" style={{ color: "#257251" }}>{t("company_name")}</h1>
                        ...
                        <hr className="mb-4 responsive-margin-top" style={{ border: "1px solid #9db2e1" }} />
                    </div>
                    <div className="col-md-6">
